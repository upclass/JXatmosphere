...
public class DmcgjcMenuAdapterForSwzd extends BaseQuickAdapter<DmcgjcmenuBeen.DataBean, BaseViewHolder> {
    ...
    public DmcgjcMenuAdapterForSwzd(@Nullable List<DmcgjcmenuBeen.DataBean> data) {
        super(R.layout.item_recycle_horizontal_dmcgjcforswzd_layout, data);
    }
