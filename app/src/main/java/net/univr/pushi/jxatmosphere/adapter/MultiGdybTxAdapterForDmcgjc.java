...
public class MultiGdybTxAdapterForDmcgjc extends BaseMultiItemQuickAdapter<MultiItemGdybTx, BaseViewHolder> {
    public MultiGdybTxAdapterForDmcgjc(@Nullable List<MultiItemGdybTx> data) {
        super(data);
        addItemType(MultiItemGdybTx.IMG, R.layout.dmcgjc_multi_layout);
