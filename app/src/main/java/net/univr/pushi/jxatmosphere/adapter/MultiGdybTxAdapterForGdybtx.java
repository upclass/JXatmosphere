...
public class MultiGdybTxAdapterForGdybtx extends BaseMultiItemQuickAdapter<MultiItemGdybTx, BaseViewHolder> {
    public MultiGdybTxAdapterForGdybtx(@Nullable List<MultiItemGdybTx> data) {
        super(data);
        addItemType(MultiItemGdybTx.IMG, R.layout.gdybtx_multi_layout);
