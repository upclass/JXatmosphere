...
public class LdptRadarActivity extends BaseActivity implements View.OnClickListener {
    ...
    int marginleft;
    LdptRadarFragment fragment;
    LdptRadarFragment fragment1;


    @Override
    public int getLayoutId() {
        return R.layout.activity_ldpt_radar;
    }
    ...
    private void initView() {
        ...
        String flag = "0";
        fragment = LdptRadarFragment.newInstance(flag);
        String flag1 = "1";
        fragment1 = LdptRadarFragment.newInstance(flag1);
