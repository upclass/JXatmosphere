...
public class DmcgjcCustomMenuAdapter extends BaseQuickAdapter<DmcgjcmenuBeen.DataBean, BaseViewHolder> {
    ...
    public DmcgjcCustomMenuAdapter(@Nullable List<DmcgjcmenuBeen.DataBean> data) {
